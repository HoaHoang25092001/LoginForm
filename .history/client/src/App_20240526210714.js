          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            ...
            <div>
              ...
              <div className='flex items-center justify-between w-full'>
                ...
                {!isRegister && (
                  <span className='hover:underline cursor-pointer' onClick={() => setIsRegister(true)}>
                    Register here
                  </span>
                )}
                {isRegister && (
                  <span className='text-blue-500 hover:underline cursor-pointer' onClick={() => setIsRegister(false)}>
                    Back to login
                  </span>
                )}
              </div>
