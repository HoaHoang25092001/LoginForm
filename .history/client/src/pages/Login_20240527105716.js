...
function Login() {
    ...
    const handleForgotPassword = async () => {
        ...
        if (response.data.status) {
            toast.success(response.data.mes, { theme: "colored" })
        } else toast.info(response.data.res, { theme: "colored" })
    }
    ...
    const finalRegister = async () => {
        ...
        console.log('res-fn', response)
        if (response.data.status) {
            Swal.fire("Congratulation", response.data.mes, "success").then(() => {
                setIsRegister(false)
                resetPayload()
            })
        } else Swal.fire("Oops!", response.data.mes, "error")
    ...
    return (
        <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5 relative">
            {isVerifiedEmail && (
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gray-700 opacity-25 mix-blend-overlay z-50 flex flex-col justify-center items-center">
                    <div className="bg-white w-[90%] max-w-[500px] rounded-md p-8 z-60">
                        <h4 className="mb-4">
            ...
            {isForgotPassword && (
                <div className="absolute top-0 left-0 bottom-0 right-0 bg-white flex flex-col items-center px-4 py-8 z-50">
                    <div className="flex w-2/3 flex-col gap-4">
                        <label htmlFor="email">Enter your email:</label>
                        <input
                            type="text"
                            id="email"
                            className="md:w-[800px] w-full pb-2 border-b rounded-lg outline-none placeholder:text-sm p-4"
                        ...
                        <div className="flex items-center justify-end w-2/3 gap-4">
                            <button
                                ...
                                className="px-4 py-2 rounded-md text-white bg-blue-500 text-semibold my-2"
                            >
                                Submit
                            </button>
                            <button
                                ...
                                className="px-4 py-2 rounded-md text-white bg-red-400 text-semibold my-2"
                            >
                                Back
                            </button>
                        </div>
                ...
                <div className="md:flex w-full">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div className="text-center mb-10">
                            ...
                            <p>{isRegister ? 'Enter your information to Register' : 'Enter your email and password to Login'}</p>
                        </div>
                        <div>
                            {isRegister && (
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5 justify-center">
                                    <Button
