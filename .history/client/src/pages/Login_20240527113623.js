...
function Login() {
            ...
            if (isRegister) {
                ...
                if (rs.data.status) {
                    ...
                    searchParams.get("redirect")
                        ...
                        : navigate(`/${path.HOME}`)
                } else Swal.fire("Oops!", rs.data.mes, "error")
            }
        }
    ...
    return (
        <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5 relative">
            {isVerifiedEmail && (
                <div className="absolute top-0 left-0 right-0 bottom-0 z-50 flex flex-col justify-center items-center" style={{ 'backgroundColor': 'rgba(0,0,0,0.7)' }}>
