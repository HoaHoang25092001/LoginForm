...
function App() {
  ...
  return (
    <div classNameName="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
      <div classNameName="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ "max-width": "1000px" }}>
        <div classNameName="md:flex w-full">
          <div classNameName="hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
          ...
          <div classNameName="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div classNameName="text-center mb-10">
              <h1 classNameName="font-bold text-3xl text-gray-900">{isRegister ? 'REGISTER' : 'LOGIN'}</h1>
            ...
            <div>
              ...
              <div classNameName="flex -mx-3">
                <div classNameName="w-full px-3 mb-5">
                  <label for="" classNameName="text-xs font-semibold px-1">Email</label>
                  <div classNameName="flex">
                    <div classNameName="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i classNameName="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                    <InputField
                      type='email'
                      placeholder='hoadev@example.com'
                      nameKey='email'
                      value={payload.email}
                      setValue={setPayload}
                    />
              ...
              <div classNameName="flex -mx-3">
                <div classNameName="w-full px-3 mb-12">
                  <label for="" classNameName="text-xs font-semibold px-1">Password</label>
                  <div classNameName="flex">
                    <div classNameName="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i classNameName="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                    <InputField
                      type='password'
                      placeholder='************'
                      nameKey='password'
              ...
              <div classNameName="flex -mx-3">
                <div classNameName="w-full px-3 mb-5 justify-center">
                  <Button
                    name={isRegister ? 'REGISTER NOW' : 'LOGIN HERE'}
                    handleOnclick={handleSubmit}
                  />
                </div>
              </div>
              <div classNameName='flex items-center justify-between w-full'>
                <span classNameName='hover:underline cursor-pointer'>Forgot your password?</span>
                <span classNameName='hover:underline cursor-pointer' onClick={() => setIsRegister(true)}>Register here</span>
              </div>
            </div>
          </div>
        </div>
